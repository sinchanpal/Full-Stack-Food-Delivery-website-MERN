...
const OwnerDashboard = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
      ...
      {/* If there is no shop data, show the add your restaurant card */}
      {!myShopData &&
      ...
      {myShopData &&
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          ...
          <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
            ...
            <img src={myShopData.image} alt={myShopData.name} className='w-full h-48 sm:h-64 bg-cover' />

            <div className='p-4 sm:p-6'>
              <h1 className='text-xl sm:text-2xl font-bold mb-2 text-[#ff4d2d]'>{myShopData.name}</h1>
              <p className='text-gray-600 text-lg sm:text-xl mb-2'>{myShopData.city}, {myShopData.state}</p>
              <p>{myShopData.address}</p>

            </div>
          </div>

          {/* If there are no items, show the add your items card  */}
          {myShopData.items.length === 0 &&
            ...
            <div className='flex justify-center items-center p-4 sm:p-6'>
              <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                <div className='flex flex-col items-center text-center'>
                  <FaUtensils className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4' />
                  <h2 className='text-xl sm:text-2xl font-bold text-gray-800 mb-2'>Add Your Items</h2>
                  <p className='text-gray-600 mb-4 text-sm sm:text-base'>Add your delicious menu items to your restaurant.</p>
